...
#sudo chmod 766 configurations/linux/install/K8_cento_Install1/kubernetes_cento_master_install.sh &&  sudo configurations/linux/install/K8_cento_Install1/kubernetes_cento_master_install.sh && mkdir -p $HOME/.kube && sudo cp -i /etc/kubernetes/admin.conf $HOME/.kube/config && sudo chown $(id -u):$(id -g) $HOME/.kube/config
